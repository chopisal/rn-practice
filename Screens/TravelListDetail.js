...
import { Dimensions, View, Text, Image, Animated, StyleSheet, ImageBackground } from "react-native";
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <SharedElement
        ...
        style={{ position: "absolute", width: ITEM_WIDTH - SPACING * 2, top: 100, left: 34 }}
      >
        <Text
          style={{
            fontSize: 32,
