...
function SalonListDetails({ navigation, route }) {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <SharedElement
        id="general.bg"
        style={[StyleSheet.absoluteFillObject, { transform: [{ translateY: height }] }]}
      >
        <View
          style={[
            StyleSheet.absoluteFillObject,
            ...
            <View style={{ margin: SPACING * 2 }}>
              {item.categories.map((subcat, index) => {
                return (
                  ...
                  >
                    <Text
                      style={{ ...fonts.montserratRegular, fontSize: 22, marginBottom: SPACING }}
                    >
                      {subcat.title}
                    </Text>
